...
\item[] By far the greatest assumption which simplifies the neutron transport equation to the neutron diffusion equation is the assumption that angular flux is \emph{linearly anisotropic}, that is, while not necessarily perfectly uniform over angle, it can at least be described by a linear function of angle.
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.4\linewidth]{figures/hw3Q_star.png}
\end{figure}
