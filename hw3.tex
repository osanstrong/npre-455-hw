...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.25\linewidth]{figures/pc.png}
\end{figure}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.3\linewidth]{figures/hw2_flux.png}
\end{figure}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.4\linewidth]{figures/star.png}
\end{figure}
