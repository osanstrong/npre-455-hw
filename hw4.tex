...
\item[] \ans{
    ...
    The negligible amount of neutrons leaving the sphere also makes sense, as our diffusion length $L=\sqrt{\frac{D}{\Sigma_a}}=1.342~\mathrm{cm}$ is \emph{far} lower than the length neutrons have to go to escape the sphere ($R=100~\mathrm{cm}$).
}
