...
\item[] \ans{
    ...
    {\footnotesize\begin{equation}
        \phi_1(x)=\frac{2L_1L_2S\left(\left(1-\exp(\btoL)\right)*\exp(\frac{\tilde{a}}{L_1})\times\sinh\left(\frac{-\tilde{a}-x}{L_1}\right)\right)}{D_1L_2\left(\exp(\btoL)-\exp(\atoL)+\exp(\btoL+\atoL)-   1\right)+D_2L_1\left(\exp(\atoL)-\exp(\btoL)+\exp(\btoL+\atoL)-1\right)}
    \end{equation}
    \begin{equation}
        \phi_2(x)=\frac{-2L_1L_2S\left(1-\exp(\atoL)\right)*\exp(\frac{\tilde{b}}{L_2})\times\sinh\left(\frac{\tilde{b}-x}{L_2}\right)}{D_1L_2\left(\exp(\btoL)-\exp(\atoL)+\exp(\btoL+\atoL)-   1\right)+D_2L_1\left(\exp(\atoL)-\exp(\btoL)+\exp(\btoL+\atoL)-1\right)}
    \end{equation}
